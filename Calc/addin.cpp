...
namespace Addin {
    ...
    class QuantLib_AnalyticHestonHullWhiteEngineError: public std::exception {
        const char * what () const throw () { 
            return "Wrong template arguments for QuantLib::AnalyticHestonHullWhiteEngine";
        };
    };
    
    QuantLib_AnalyticHestonHullWhiteEngine::QuantLib_AnalyticHestonHullWhiteEngine(IDL_any HestonModel_any, IDL_any HullWhiteModel_any, IDL_any IntegrationOrder_any)
            : ObjectHandler::Object(std::string("QuantLib_AnalyticHestonHullWhiteEngine"))
        {
            // set constructor method
            object_ = 0L;
            method_ = 0;
            ...
            // store parameters 
            arguments_.push_back(HestonModel_any);
            arguments_.push_back(HullWhiteModel_any);
            arguments_.push_back(IntegrationOrder_any);
            
            // call update to create object
            update();
        };
    
    void QuantLib_AnalyticHestonHullWhiteEngine::update() {
        del();
        if (method_==0) {
            // convert back from boost::any
            std::cerr << "in upate() von QuantLib::AnalyticHestonHullWhiteEngine" << std::endl;
            this->precedentIDs_.clear();
            IDL_any HestonModel_any;
            HestonModel_any = boost::any_cast<IDL_any >(arguments_[0]);
            IDL_any HullWhiteModel_any;
            HullWhiteModel_any = boost::any_cast<IDL_any >(arguments_[1]);
            IDL_any IntegrationOrder_any;
            IntegrationOrder_any = boost::any_cast<IDL_any >(arguments_[2]);
            
            // parameter conversions 
            IDL_string HestonModel;
            boost::shared_ptr<QuantLib::HestonModel >  HestonModel_cpp;
            if(HestonModel_any.hasValue()) { 
                scalarAnyToIDL(HestonModel_any, HestonModel);
                scalarObjectSharedPtr(HestonModel, HestonModel_cpp); 
                this->precedentIDs_.insert(getObjectName(HestonModel));
            } else { 
                throw AddinException("no parameter value for HestonModel");
            }
            
            IDL_string HullWhiteModel;
            boost::shared_ptr<QuantLib::HullWhite >  HullWhiteModel_cpp;
            if(HullWhiteModel_any.hasValue()) { 
                scalarAnyToIDL(HullWhiteModel_any, HullWhiteModel);
                scalarObjectSharedPtr(HullWhiteModel, HullWhiteModel_cpp); 
                this->precedentIDs_.insert(getObjectName(HullWhiteModel));
            } else { 
                throw AddinException("no parameter value for HullWhiteModel");
            }
            
            IDL_long IntegrationOrder;
            long IntegrationOrder_cpp;
            if(IntegrationOrder_any.hasValue()) { 
                scalarAnyToIDL(IntegrationOrder_any, IntegrationOrder);
                scalarInterfaceToCpp(IntegrationOrder, IntegrationOrder_cpp, interfaceToIdentity);
            } else { 
                IntegrationOrder_cpp = 144; 
            }
            
            // create addin object
            object_ = (void *)(new QuantLib::AnalyticHestonHullWhiteEngine(HestonModel_cpp, HullWhiteModel_cpp, IntegrationOrder_cpp));
        }
        
    };
    
    void QuantLib_AnalyticHestonHullWhiteEngine::del() {
        if (method_==0) {
            // convert back from boost::any
            IDL_any HestonModel_any;
            HestonModel_any = boost::any_cast<IDL_any >(arguments_[0]);
            ...
            if(!object_) return;
            // delete addin object
            delete (QuantLib::AnalyticHestonHullWhiteEngine *)(object_);
        }
        object_ = (void *)(0L);
    };
    ...
    class QuantLib_HullWhiteError: public std::exception {
        const char * what () const throw () { 
            return "Wrong template arguments for QuantLib::HullWhite";
        };
    };
    
    QuantLib_HullWhite::QuantLib_HullWhite(IDL_any TermStructure_any, IDL_any A_any, IDL_any Sigma_any)
            : ObjectHandler::Object(std::string("QuantLib_HullWhite"))
        {
            // set constructor method
            object_ = 0L;
            method_ = 0;
            ...
            // store parameters 
            arguments_.push_back(TermStructure_any);
            arguments_.push_back(A_any);
            arguments_.push_back(Sigma_any);
            
            // call update to create object
            update();
        };
    
    void QuantLib_HullWhite::update() {
        del();
        if (method_==0) {
            // convert back from boost::any
            std::cerr << "in upate() von QuantLib::HullWhite" << std::endl;
            this->precedentIDs_.clear();
            IDL_any TermStructure_any;
            TermStructure_any = boost::any_cast<IDL_any >(arguments_[0]);
            IDL_any A_any;
            A_any = boost::any_cast<IDL_any >(arguments_[1]);
            IDL_any Sigma_any;
            Sigma_any = boost::any_cast<IDL_any >(arguments_[2]);
            
            // parameter conversions 
            IDL_string TermStructure;
            QuantLib::Handle<QuantLib::YieldTermStructure >  TermStructure_cpp;
            if(TermStructure_any.hasValue()) { 
                scalarAnyToIDL(TermStructure_any, TermStructure);
                scalarObjectHandle(TermStructure, TermStructure_cpp); 
                this->precedentIDs_.insert(getObjectName(TermStructure));
            } else { 
                throw AddinException("no parameter value for TermStructure");
            }
            
            IDL_double A;
            double A_cpp;
            if(A_any.hasValue()) { 
                scalarAnyToIDL(A_any, A);
                scalarInterfaceToCpp(A, A_cpp, interfaceToIdentity);
            } else { 
                A_cpp = 0.01; 
            }
            ...
            IDL_double Sigma;
            double Sigma_cpp;
            if(Sigma_any.hasValue()) { 
                scalarAnyToIDL(Sigma_any, Sigma);
                scalarInterfaceToCpp(Sigma, Sigma_cpp, interfaceToIdentity);
            } else { 
                Sigma_cpp = 0.01; 
            }
            
            // create addin object
            object_ = (void *)(new QuantLib::HullWhite(TermStructure_cpp, A_cpp, Sigma_cpp));
        }
        
    };
    
    void QuantLib_HullWhite::del() {
        if (method_==0) {
            // convert back from boost::any
            IDL_any TermStructure_any;
            TermStructure_any = boost::any_cast<IDL_any >(arguments_[0]);
            ...
            if(!object_) return;
            // delete addin object
            delete (QuantLib::HullWhite *)(object_);
        }
        object_ = (void *)(0L);
    };
    ...
    class QuantLib_HestonModelError: public std::exception {
        const char * what () const throw () { 
            return "Wrong template arguments for QuantLib::HestonModel";
        };
    };
    
    QuantLib_HestonModel::QuantLib_HestonModel(IDL_any Process_any)
            : ObjectHandler::Object(std::string("QuantLib_HestonModel"))
        {
            // set constructor method
            object_ = 0L;
            method_ = 0;
            ...
            // store parameters 
            arguments_.push_back(Process_any);
            
            // call update to create object
            update();
        };
    
    void QuantLib_HestonModel::update() {
        del();
        if (method_==0) {
            // convert back from boost::any
            std::cerr << "in upate() von QuantLib::HestonModel" << std::endl;
            this->precedentIDs_.clear();
            IDL_any Process_any;
            Process_any = boost::any_cast<IDL_any >(arguments_[0]);
            
            // parameter conversions 
            IDL_string Process;
            boost::shared_ptr<QuantLib::HestonProcess >  Process_cpp;
            if(Process_any.hasValue()) { 
                scalarAnyToIDL(Process_any, Process);
                scalarObjectSharedPtr(Process, Process_cpp); 
                this->precedentIDs_.insert(getObjectName(Process));
            } else { 
                throw AddinException("no parameter value for Process");
            }
            
            // create addin object
            object_ = (void *)(new QuantLib::HestonModel(Process_cpp));
        }
        
    };
    
    void QuantLib_HestonModel::del() {
        if (method_==0) {
            // convert back from boost::any
            IDL_any Process_any;
            Process_any = boost::any_cast<IDL_any >(arguments_[0]);
            ...
            if(!object_) return;
            // delete addin object
            delete (QuantLib::HestonModel *)(object_);
        }
        object_ = (void *)(0L);
    };
    ...
    class QuantLib_HestonProcessError: public std::exception {
        const char * what () const throw () { 
            return "Wrong template arguments for QuantLib::HestonProcess";
        };
    };
    
    QuantLib_HestonProcess::QuantLib_HestonProcess(IDL_any RiskFreeRate_any, IDL_any DividendYield_any, IDL_any S0_any, IDL_any V0_any, IDL_any Kappa_any, IDL_any Theta_any, IDL_any Sigma_any, IDL_any Rho_any, IDL_any D_any)
            : ObjectHandler::Object(std::string("QuantLib_HestonProcess"))
        {
            // set constructor method
            object_ = 0L;
            method_ = 0;
            ...
            // store parameters 
            arguments_.push_back(RiskFreeRate_any);
            arguments_.push_back(DividendYield_any);
            arguments_.push_back(S0_any);
            arguments_.push_back(V0_any);
            arguments_.push_back(Kappa_any);
            arguments_.push_back(Theta_any);
            arguments_.push_back(Sigma_any);
            arguments_.push_back(Rho_any);
            arguments_.push_back(D_any);
            
            // call update to create object
            update();
        };
    
    void QuantLib_HestonProcess::update() {
        del();
        if (method_==0) {
            // convert back from boost::any
            std::cerr << "in upate() von QuantLib::HestonProcess" << std::endl;
            this->precedentIDs_.clear();
            IDL_any RiskFreeRate_any;
            RiskFreeRate_any = boost::any_cast<IDL_any >(arguments_[0]);
            IDL_any DividendYield_any;
            DividendYield_any = boost::any_cast<IDL_any >(arguments_[1]);
            IDL_any S0_any;
            S0_any = boost::any_cast<IDL_any >(arguments_[2]);
            IDL_any V0_any;
            V0_any = boost::any_cast<IDL_any >(arguments_[3]);
            IDL_any Kappa_any;
            Kappa_any = boost::any_cast<IDL_any >(arguments_[4]);
            IDL_any Theta_any;
            Theta_any = boost::any_cast<IDL_any >(arguments_[5]);
            IDL_any Sigma_any;
            Sigma_any = boost::any_cast<IDL_any >(arguments_[6]);
            IDL_any Rho_any;
            Rho_any = boost::any_cast<IDL_any >(arguments_[7]);
            IDL_any D_any;
            D_any = boost::any_cast<IDL_any >(arguments_[8]);
            
            // parameter conversions 
            IDL_string RiskFreeRate;
            QuantLib::Handle<QuantLib::YieldTermStructure >  RiskFreeRate_cpp;
            if(RiskFreeRate_any.hasValue()) { 
                scalarAnyToIDL(RiskFreeRate_any, RiskFreeRate);
                scalarObjectHandle(RiskFreeRate, RiskFreeRate_cpp); 
                this->precedentIDs_.insert(getObjectName(RiskFreeRate));
            } else { 
                throw AddinException("no parameter value for RiskFreeRate");
            }
            
            IDL_string DividendYield;
            QuantLib::Handle<QuantLib::YieldTermStructure >  DividendYield_cpp;
            if(DividendYield_any.hasValue()) { 
                scalarAnyToIDL(DividendYield_any, DividendYield);
                scalarObjectHandle(DividendYield, DividendYield_cpp); 
                this->precedentIDs_.insert(getObjectName(DividendYield));
            } else { 
                throw AddinException("no parameter value for DividendYield");
            }
            
            IDL_string S0;
            QuantLib::Handle<QuantLib::Quote >  S0_cpp;
            if(S0_any.hasValue()) { 
                scalarAnyToIDL(S0_any, S0);
                scalarObjectHandle(S0, S0_cpp); 
                this->precedentIDs_.insert(getObjectName(S0));
            } else { 
                throw AddinException("no parameter value for S0");
            }
            
            IDL_double V0;
            double V0_cpp;
            if(V0_any.hasValue()) { 
                scalarAnyToIDL(V0_any, V0);
                scalarInterfaceToCpp(V0, V0_cpp, interfaceToIdentity);
            } else { 
                throw AddinException("no parameter value for V0");
            }
            
            IDL_double Kappa;
            double Kappa_cpp;
            if(Kappa_any.hasValue()) { 
                scalarAnyToIDL(Kappa_any, Kappa);
                scalarInterfaceToCpp(Kappa, Kappa_cpp, interfaceToIdentity);
            } else { 
                throw AddinException("no parameter value for Kappa");
            }
            
            IDL_double Theta;
            double Theta_cpp;
            if(Theta_any.hasValue()) { 
                scalarAnyToIDL(Theta_any, Theta);
                scalarInterfaceToCpp(Theta, Theta_cpp, interfaceToIdentity);
            } else { 
                throw AddinException("no parameter value for Theta");
            }
            ...
            if(Sigma_any.hasValue()) { 
                ...
                throw AddinException("no parameter value for Sigma");
            }
            
            IDL_double Rho;
            double Rho_cpp;
            if(Rho_any.hasValue()) { 
                scalarAnyToIDL(Rho_any, Rho);
                scalarInterfaceToCpp(Rho, Rho_cpp, interfaceToIdentity);
            } else { 
                throw AddinException("no parameter value for Rho");
            }
            
            IDL_string D;
            QuantLib::HestonProcess::Discretization D_cpp;
            if(D_any.hasValue()) { 
                scalarAnyToIDL(D_any, D);
                scalarInterfaceToCpp(D, D_cpp, QuantLib_HestonProcess_DiscretizationEnum);
            } else { 
                D_cpp = QuantLib::HestonProcess::PartialTruncation; 
            }
            
            // create addin object
            object_ = (void *)(new QuantLib::HestonProcess(RiskFreeRate_cpp, DividendYield_cpp, S0_cpp, V0_cpp, Kappa_cpp, Theta_cpp, Sigma_cpp, Rho_cpp, D_cpp));
        }
        
    };
    
    void QuantLib_HestonProcess::del() {
        if (method_==0) {
            // convert back from boost::any
            IDL_any RiskFreeRate_any;
            RiskFreeRate_any = boost::any_cast<IDL_any >(arguments_[0]);
            ...
            if(!object_) return;
            // delete addin object
            delete (QuantLib::HestonProcess *)(object_);
        }
        object_ = (void *)(0L);
    };
    ...
    QuantLib::Real QuantLib_Vasicek::discountBondOption(IDL_any ObjectId_any, IDL_any Type_any, IDL_any Strike_any, IDL_any Maturity_any, IDL_any BondMaturity_any)
    {
        ...
        IDL_string Type;
        QuantLib::Option::Type Type_cpp;
        if(Type_any.hasValue()) { 
            scalarAnyToIDL(Type_any, Type);
            scalarInterfaceToCpp(Type, Type_cpp, QuantLib_Option_TypeEnum);
        } else { 
            throw AddinException("no parameter value for Type");
        }
        ...
        IDL_string Maturity;
        QuantLib::Time *Maturity_cpp;
        if(Maturity_any.hasValue()) { 
            scalarAnyToIDL(Maturity_any, Maturity);
            scalarObject(Maturity, &Maturity_cpp); 
        } else { 
            throw AddinException("no parameter value for Maturity");
        }
        
        IDL_string BondMaturity;
        QuantLib::Time *BondMaturity_cpp;
        if(BondMaturity_any.hasValue()) { 
            scalarAnyToIDL(BondMaturity_any, BondMaturity);
            scalarObject(BondMaturity, &BondMaturity_cpp); 
        } else { 
            throw AddinException("no parameter value for BondMaturity");
        }
        
    
        QuantLib::Vasicek *ObjectId_ref = (static_cast<QuantLib::Vasicek *>(OH_GET_OBJECT_SIMPLE(ObjectId_cpp)->get()));
        // return value  
        return ObjectId_ref->discountBondOption(Type_cpp, Strike_cpp, *Maturity_cpp, *BondMaturity_cpp);
    };
    ...
    QuantLib::Real QuantLib_OneFactorAffineModel::discountBond(IDL_any ObjectId_any, IDL_any Now_any, IDL_any maturity_any, IDL_any Rate_any)
    {
        ...
        IDL_string Now;
        QuantLib::Time *Now_cpp;
        if(Now_any.hasValue()) { 
            scalarAnyToIDL(Now_any, Now);
            scalarObject(Now, &Now_cpp); 
        } else { 
            throw AddinException("no parameter value for Now");
        }
        ...
        QuantLib::OneFactorAffineModel *ObjectId_ref = (static_cast<QuantLib::OneFactorAffineModel *>(OH_GET_OBJECT_SIMPLE(ObjectId_cpp)->get()));
        // return value  
        return ObjectId_ref->discountBond(*Now_cpp, *maturity_cpp, Rate_cpp);
    };
    ...
    // generating data for QuantLib::HestonProcess::Discretization 
    
    class QuantLib_HestonProcess_DiscretizationError: public std::exception {
        const char * what () const throw () { 
            return "No conversion defined for QuantLib::HestonProcess::Discretization";
        };
    };
    
    void QuantLib_HestonProcess_DiscretizationEnum(IDL_string fromtyp, QuantLib::HestonProcess::Discretization &totyp){
        std::string fromtyp_cpp;
        scalarInterfaceToCpp(fromtyp, fromtyp_cpp, interfaceToString);
        
        if(fromtyp_cpp==std::string("NonCentralChiSquareVariance")) { 
            totyp = QuantLib::HestonProcess::NonCentralChiSquareVariance;
            return;
        };
        if(fromtyp_cpp==std::string("QuadraticExponential")) { 
            totyp = QuantLib::HestonProcess::QuadraticExponential;
            return;
        };
        if(fromtyp_cpp==std::string("FullTruncation")) { 
            totyp = QuantLib::HestonProcess::FullTruncation;
            return;
        };
        if(fromtyp_cpp==std::string("Reflection")) { 
            totyp = QuantLib::HestonProcess::Reflection;
            return;
        };
        if(fromtyp_cpp==std::string("PartialTruncation")) { 
            totyp = QuantLib::HestonProcess::PartialTruncation;
            return;
        };
        throw QuantLib_HestonProcess_DiscretizationError();
    };
