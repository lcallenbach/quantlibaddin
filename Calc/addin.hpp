...
namespace Addin {
    ...
    class QuantLib_AnalyticHestonHullWhiteEngine : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_AnalyticHestonHullWhiteEngine(IDL_any HestonModel_any, IDL_any HullWhiteModel_any, IDL_any IntegrationOrder_any);
        //inline ~QuantLib_AnalyticHestonHullWhiteEngine() { 
            //del(); 
        //}
    };
    class QuantLib_FixedRateBondHelper : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_FixedRateBondHelper(IDL_any Price_any, IDL_any SettlementDays_any, IDL_any FaceAmount_any, IDL_any Schedule_any, SEQSEQ(IDL_any) Coupons_any, IDL_any DayCounter_any, IDL_any PaymentConv_any, IDL_any Redemption_any, IDL_any Date_any, IDL_any PaymentCalendar_any, IDL_any ExCouponPeriod_any, IDL_any ExCouponCalendar_any, IDL_any ExCouponConvention_any, IDL_any ExCouponEndOfMonth_any, IDL_any UseCleanPrice_any);
        //inline ~QuantLib_FixedRateBondHelper() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_HullWhite : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_HullWhite(IDL_any TermStructure_any, IDL_any A_any, IDL_any Sigma_any);
        //inline ~QuantLib_HullWhite() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_VanillaSwap : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_VanillaSwap(IDL_any Type_any, IDL_any Nominal_any, IDL_any FixedSchedule_any, IDL_any FixedRate_any, IDL_any FixedDayCount_any, IDL_any FloatSchedule_any, IDL_any IborIndex_any, IDL_any Spread_any, IDL_any FloatingDayCount_any, IDL_any PaymentConvention_any);
        //inline ~QuantLib_VanillaSwap() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_DiscountingBondEngine : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_DiscountingBondEngine(IDL_any DiscountCurve_any, IDL_any IncludeSettlementDaysFlows_any);
        //inline ~QuantLib_DiscountingBondEngine() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_HestonModel : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_HestonModel(IDL_any Process_any);
        //inline ~QuantLib_HestonModel() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_BondHelper : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_BondHelper(IDL_any Price_any, IDL_any Bond_any, IDL_any UseCleanPrice_any);
        //inline ~QuantLib_BondHelper() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_DiscountingSwapEngine : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_DiscountingSwapEngine(IDL_any DiscountCurve_any, IDL_any IncludeSettlementDaysFlows_any, IDL_any SettlementDate_any, IDL_any NpvDate_any);
        //inline ~QuantLib_DiscountingSwapEngine() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_HestonProcess : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_HestonProcess(IDL_any RiskFreeRate_any, IDL_any DividendYield_any, IDL_any S0_any, IDL_any V0_any, IDL_any Kappa_any, IDL_any Theta_any, IDL_any Sigma_any, IDL_any Rho_any, IDL_any D_any);
        //inline ~QuantLib_HestonProcess() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_RiskyFixedBond : public ObjectHandler::Object {
        std::vector<boost::any> arguments_;
        int method_;
        virtual void update();
        virtual void del();
        public:
        QuantLib_RiskyFixedBond(IDL_any Name_any, IDL_any Ccy_any, IDL_any RecoveryRate_any, IDL_any DefaultTS_any, IDL_any Schedule_any, IDL_any Rate_any, IDL_any DayCounter_any, IDL_any PaymentConvention_any, SEQSEQ(IDL_any) Notionals_any, IDL_any YieldTS_any);
        //inline ~QuantLib_RiskyFixedBond() { 
            //del(); 
        //}
    };
    ...
    class QuantLib_Vasicek {
        public:
        QuantLib_Vasicek() {};
        static QuantLib::Real discountBondOption(IDL_any ObjectId_any, IDL_any Type_any, IDL_any Strike_any, IDL_any Maturity_any, IDL_any BondMaturity_any);
    };
    ...
    class QuantLib_OneFactorAffineModel {
        public:
        QuantLib_OneFactorAffineModel() {};
        static QuantLib::Real discountBond(IDL_any ObjectId_any, IDL_any Now_any, IDL_any maturity_any, IDL_any Rate_any);
    };
    class QuantLib_RiskyBond {
        public:
        QuantLib_RiskyBond() {};
        static QuantLib::Currency ccy(IDL_any ObjectId_any);
    };
