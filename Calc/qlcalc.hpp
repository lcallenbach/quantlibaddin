...
public:
    ...
    SEQSEQ(IDL_any) SAL_CALL qlBondZspreadFromCleanPrice(const IDL_any &Bond_any, const IDL_any &CleanPrice_any, const IDL_any &YTS_any, const IDL_any &DayCounter_any, const IDL_any &Compounding_any, const IDL_any &Frequency_any);
