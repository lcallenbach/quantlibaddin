...
public:
    ...
    SEQSEQ(IDL_any) SAL_CALL qlRiskyBond(const IDL_any &ObjectId_any, const IDL_any &Name_any, const IDL_any &Ccy_any, const IDL_any &RecoveryRate_any, const IDL_any &DefaultTS_any, const IDL_any &Schedule_any, const IDL_any &Rate_any, const IDL_any &DayCounter_any, const IDL_any &PaymentConvention_any, const SEQSEQ(IDL_any) &Notionals_any, const IDL_any &YieldTS_any);
