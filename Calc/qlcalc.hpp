...
public:
    ...
    SEQSEQ(IDL_any) SAL_CALL qlAnalyticHestonHullWhiteEngine(const IDL_any &ObjectId_any, const IDL_any &HestonModel_any, const IDL_any &HullWhiteModel_any, const IDL_any &IntegrationOrder_any);
    ...
    SEQSEQ(IDL_any) SAL_CALL qlHullWhiteModel(const IDL_any &ObjectId_any, const IDL_any &TermStructure_any, const IDL_any &A_any, const IDL_any &Sigma_any);
    ...
    SEQSEQ(IDL_any) SAL_CALL qlHestonModel(const IDL_any &ObjectId_any, const IDL_any &Process_any);
    ...
    SEQSEQ(IDL_any) SAL_CALL qlHestonProcess(const IDL_any &ObjectId_any, const IDL_any &RiskFreeRate_any, const IDL_any &DividendYield_any, const IDL_any &S0_any, const IDL_any &V0_any, const IDL_any &Kappa_any, const IDL_any &Theta_any, const IDL_any &Sigma_any, const IDL_any &Rho_any, const IDL_any &D_any);
    ...
    SEQSEQ(IDL_any) SAL_CALL qlVasicekDiscountBondOption(const IDL_any &ObjectId_any, const IDL_any &Type_any, const IDL_any &Strike_any, const IDL_any &Maturity_any, const IDL_any &BondMaturity_any);
    ...
    SEQSEQ(IDL_any) SAL_CALL qlOneFactorAffinceModelDiscountBond(const IDL_any &ObjectId_any, const IDL_any &Now_any, const IDL_any &maturity_any, const IDL_any &Rate_any);
